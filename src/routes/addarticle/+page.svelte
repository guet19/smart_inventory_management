...
<script>
  ...
  function handleImageSelect(event) {
    ...
    if (file) {
      // Erstellt eine temporäre Vorschau-URL im Browser-Speicher
  ...
  function removeImage() {
    imagePreview = null;
    if (fileInputElement) {
      fileInputElement.value = ""; // Leert das Input-Feld, damit das Bild nicht hochgeladen wird
    }
  }
</script>
...
<div class="page-container">
  ...
  >
    ...
    <div class="form-section">
      ...
      <!-- Artikelbild mit Vorschau und Löschfunktion -->
      <div class="form-group" style="margin-top: 1rem;">
        ...
        <!-- Wird nur angezeigt, wenn ein Bild ausgewählt wurde -->
        {#if imagePreview}
