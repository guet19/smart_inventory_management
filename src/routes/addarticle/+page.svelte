    ...
    >
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    id="title"
                    name="title"
                    placeholder="z.B. Widerstand 10kOhm"
                    required
                />
            </div>
            ...
            <div class="form-group">
                ...
                <textarea
                    ...
                    name="description"
                    rows="3"
                    placeholder="Genaue Beschreibung des Artikels..."
                    required
                ></textarea>
            </div>
            ...
            <div
                class="form-group"
                style="margin-top: 2rem; border-top: 1px dashed #cbd5e1; padding-top: 1rem;"
            >
                ...
                {#if isCropping}
                    <div class="cropper-container">
                        <p class="cropper-instruction">
                            Wähle den gewünschten Bildausschnitt (16:9)
                        </p>
                        ...
                        <div class="cropper-actions">
                            <button
                                type="button"
                                class="btn-cancel"
                                on:click={cancelCrop}>Abbrechen</button
                            >
                            <button
                                type="button"
                                class="btn-apply"
                                on:click={applyCrop}
                                >Ausschnitt speichern</button
                            >
                        </div>
                    </div>
                {/if}
        ...
        <div class="form-actions">
            <button type="submit" class="btn-submit"
                >Artikel in Datenbank speichern</button
            >
        </div>
    </form>
</div>
