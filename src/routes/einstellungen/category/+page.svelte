  ...
  <div class="row">
    ...
    {#if activeCategory && activeSubcategory}
      <div class="col-12 animate-fade-in">
        <div class="card shadow border-0 overflow-hidden">
          <div
            class="card-header bg-dark text-white p-4 d-flex justify-content-between align-items-center"
          >
            <div>
                <span class="mt-5" style="font-size: 30px; color: #22C55E !important;">
                  {activeSubcategory.name}</span
                >
                <br>
              <span
                class="text-secondary small text-uppercase fw-bold"
                style="color: white !important;">Filterattribute der Kategorie zuweisen</span
              >
            ...
            >
                ...
                <div class="row g-3">
                  {#each filteredAttributes as attr}
                    <div class="col-md-6 col-lg-4">
                      <div
                        class="form-check p-3 border rounded h-100 d-flex align-items-center form-check-custom"
                      >
                        <input
                          ...
                          value={attr._id}
                          id="attr-{attr._id}"
                          checked={activeSubcategory.allowed_attributes?.includes(
                            attr._id,
                          )}
                        />
                        <label
                          class="form-check-label w-100 d-flex flex-column"
              ...
              <div class="d-flex justify-content-end gap-3">
                <button
                  ...
                  onclick={closeAttributeEdit}>Abbrechen</button
                >
                <button
                  type="submit"
    ...
    {:else}
      <div class="col-md-4 mb-4 animate-fade-in">
        <div
          class="card shadow-sm border-0 bg-dark text-white p-4 sticky-top"
          style="top: 2rem;"
        >
            ...
            <div class="list-group-item p-0 overflow-hidden bg-white">
              ...
              >
                ...
                {:else}
                  ...
                  <div
                    ...
                    tabindex="0"
                    onkeydown={(e) =>
                      e.key === "Enter" && toggleCategory(category._id)}
                  >
              ...
              {#if expandedId === category._id || searchQuery.trim() !== ""}
                <div class="p-3 bg-light border-top">
                  ...
                  {#if category.subcategories && category.subcategories.length > 0}
                    ...
                    <div class="d-flex flex-column gap-2 mb-4">
                      {#each sortedSubs as sub}
                        <div
                          class="bg-white text-dark border rounded px-3 py-3 shadow-sm d-flex justify-content-between align-items-center"
                        >
                          ...
                          <div>
                            <button
                              type="button"
                              class="btn btn-outline-primary fw-bold px-3 me-3 shadow-sm"
                              onclick={() =>
                                openAttributeEdit(category._id, sub.id)}
                            >
                  ...
                  {#if searchQuery.trim() === ""}
                    <div
                      class="bg-white p-3 rounded border border-secondary-subtle"
                    >
                      <label
